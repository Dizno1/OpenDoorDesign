...
function renderConfirmationEmail(member, config) {
  ...
  const text = [
    ...
    "What you can do now",
    "",
    "When you are ready, sign in to your Community Dashboard:",
    "https://opendoordesign.org/community/sign-in/",
    "",
    ...
    "What is coming",
    "",
    "The Community is still being built. Passwordless member sign-in, a protected Dashboard, sign out, and basic profile editing are available now. Next steps include Directory profile controls, Community activity, discussions, communication preferences, and additional ways for members to participate and connect around shared interests, experiences, research, and projects.",
    "",
  ...
  const html = [
    ...
    '<p>When you are ready, <a href="https://opendoordesign.org/community/sign-in/">sign in to your Community Dashboard</a>. Enter the email address used during registration and the Community will send a secure, single-use sign-in link.</p>',
    ...
    "<p>The Community is still being built. Passwordless member sign-in, a protected Dashboard, sign out, and basic profile editing are available now. Next steps include Directory profile controls, Community activity, discussions, communication preferences, and additional ways for members to participate and connect around shared interests, experiences, research, and projects.</p>",
